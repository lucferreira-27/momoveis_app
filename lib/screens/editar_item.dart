...
const String _titulo = "Editar Item";
const String _lblNome = "Nome";
const String _lblResponsavel = "Responsável";
const String _btnRegistrar = "Salvar";
const String _msgSucesso = "Item editado com sucesso";
...
class _EditarItemState extends State<EditarItem> {
  ...
  Widget build(BuildContext context) {
    ...
    itemDao =  ModalRoute.of(context).settings.arguments;
    _controllerItemNome.text = itemDao.nome;
    _controllerResponsavelNome.text = itemDao.responsavel;
  ...
  _registrar(BuildContext context) {
    if (_formKey.currentState.validate()) {
      ...
      itemDao.nome = _controllerItemNome.text;
      itemDao.responsavel = _controllerResponsavelNome.text;
      itemDao.tamanho = _tamanho.toString().split('.').last;
      itemDao.novo = _checkedValue;
      Navigator.pop(context, itemDao);
    }
  }
